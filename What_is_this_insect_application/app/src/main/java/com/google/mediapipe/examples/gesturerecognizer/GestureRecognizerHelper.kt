...
class GestureRecognizerHelper(
    ...
    fun recognizeLiveStream(
        ...
        Log.v(TAG, "ImageProxyからBitmapに変換時のbytebuffer(bitmap)のサイズ:"  + (bitmapBuffer.byteCount).toString())
    ...
    fun recognizeLiveStream(
        ...
        // 入力BitmapオブジェクトをMPImageに変換して推論を実行
    ...
    fun setResultListener(listener: GestureRecognizerListener) {
